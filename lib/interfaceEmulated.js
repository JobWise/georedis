...
EmulatedInterface.prototype.geoAddMulti = function(locationSet, zSetName, callBack) {
...
EmulatedInterface.prototype.geoPosMulti = function(members, zSetName, callBack) {
  var client = this.client;
  var multi = client.multi();
  var locationSet = {};
  var i;
