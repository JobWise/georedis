...
EmulatedInterface.prototype.geoadd = function(locationName, point, zSetName) {
   exec(this.client.zadd.bind(this), [zSetName, geohash.encode_int(point.latitude, point.longitude, 52), locationName]);
};
